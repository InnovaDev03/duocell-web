...
include('../Model/Model_gb_parametrizacion.php');
...
{ 
    ...
    foreach ($movements as $data) {
        ...
        {
            $dato['button']        =  '
                                  <button type="button" pr_id="'.$data['id'].'" pr_nombre="'.$data['nombre'].'" class="btn btn-xs btn-success btn_select_cadena"><acronym title="Seleccionar Cadena!" lang="es"><i class="fa fa-eye"></i></acronym></button> 
