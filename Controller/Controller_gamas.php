...
{ 
    ...
    foreach ($movements as $data) {
        ...
        $dato['ciudad']        =  $data['gama'];

        $dato['button']        =  '
        <button type="button" pr_id="'.$data['id'].'" pr_nombre="'.$data['nombre'].'" pr_ciudad ="'.$data['gama'].'"  class="btn btn-xs btn-warning btn_load_edit_cadena"><acronym title="Editar cadena!" lang="es"><i class="far fa-edit"></i></acronym></button>
        <button type="button" pr_id ="'.$data['id'].'" pr_nombre="'.$data['nombre'].'"   class="btn btn-xs btn-danger btn_delete_cadena"><acronym title="Deshabilitar cadena!" lang="es"><i class="fa fa-trash" aria-hidden="true"></i></acronym></button>';
