...
<div id="mensaje2"></div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Registro Gamas</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">

                <button type="button" class="pull-right btn btn-default" id="sendEmail">Gamas
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Interfaz para registrar/editar/eliminar Gamas.
              </h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Registro de Gamas</h5>
                    </div>
                    <div class="card-body">
                      <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Nombre del Equipo</strong><span style="color:#ff0000;">*</span></label>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Gama</strong><span style="color:#ff0000;">*</span></label>
                            <select id="txt_ciudad_cadena" class="form-control">
                                <option>Entry</option>
                                <option>M/H</option>
                            </select>
                          </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="text-rihgt" id="create_cadena">
                              ...
                              <button type="button" id="btn_save_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Crear Gama</button>
                            </div>
                            ...
                            <button type="button" id="btn_cancelar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Cancelar </button>
                              <button type="button" id="btn_editar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Editar Gama</button>
                            </div>
                ...
                <div class="col-lg-8">
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Consulta de Gamas</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="table_cadenas" class="table table-striped table-bordered text-rigth tabla_detalle_fp">
                              <thead>
                                <tr>
                                  ...
                                  <td style="width:10px">Nombre del Equipo</td>
                                  <td style="width:80px">Gama</td>
