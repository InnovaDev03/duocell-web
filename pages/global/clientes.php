    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Registro/consulta clientes</h1>
            </div>
           <!-- <div class="col-sm-6">
      ...
      <div class="content">
        ...
        <h3 class="card-title">
                    ...
                    Interfaz para registrar/editar/eliminar clientes.
                  </h3>
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <strong>RUC</strong><span style="color:#ff0000;">*</span></label>
                        <input type="text" class="form-control" id="txt_identificacion" maxlength="20" autocomplete="off" onkeypress='return validaNumericos(event)' onChange="validar_identificacion(this.value)" />
                      </div>
                    </div>
                  <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <strong>Nombre</strong><span style="color:#ff0000;">*</span></label>
                        <input type="text" class="form-control" id="txt_nombre" autocomplete="off" oninput="this.value = this.value.toUpperCase()" />
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txt_direccion" autocomplete="off" oninput="this.value = this.value.toUpperCase()" />
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txt_telefono" autocomplete="off" maxlength="20" onkeypress='return validaNumericos(event)'/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <strong>Email</strong>
                        <input type="text" class="form-control" id="txt_email" autocomplete="off" maxlength="40" onChange='validarEmail()'/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        ...
                        <div class="text-rihgt" id="create_cliente">
                          ...
                          <button type="button" id="btn_save_cliente"  class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Crear Cliente</button>
                        </div>

                        <div class="text-rihgt" id="editar_cliente" style="display: none;">


                          <button type="button" id="btn_editar_cliente"  class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Editar Cliente</button>
                        </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="table-responsive demo-x content">
                        ...
                        <div class="box-body">
                          ...
                          <table id="table_clientes" class="table table-striped table-bordered text-center tabla_detalle_fp">
                            <thead>
                              <tr>
                                <td style="width:10px">#</td>
                                <td style="width:10px">Nombre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td style="width:10px">Dirección&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td style="width:10px">Email/Telefono/Logo</td>
...
<!--
          <div class="row">
            <div class="col-lg-4">
              ...
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <h5 class="m-0">Registro de Tarifas</h5>
                </div>
                <div class="card-body">
                  <div class="col-lg-12">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        ...
                        <div class="text-rihgt" id="create_servicio">
                          ...
                          <button type="button" id="btn_save_servico"  class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Crear Tarifa</button>
                        </div>

                        <div class="text-rihgt" id="editar_servico" style="display: none;">


                          <button type="button" id="btn_editar_servicio"  class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Editar Tarifa</button>
                        </div>
            ...
            <div class="col-lg-8">
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <h5 class="m-0">Consulta de Tarifas</h5>
                </div>
                <div class="card-body">
      ...
      /.card-body -->
        <div class="card-footer">
          Pre-Registro/Consulta clientes
        </div>
        <!-- /.card-footer-->
      </div>
