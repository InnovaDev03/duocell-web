...
/* Estilo para el indicador (check) dentro del checkbox cuando está marcado */
.custom-checkbox:checked::after {
  content: '\2713'; /* Carácter Unicode para check */
  display: block;
  width: 100%;
  height: 100%;
  color: #fff;
...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Bloqueo</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">

								<button type="button" class="pull-right btn btn-default" id="sendEmail">Sistema<i class="fa fa-arrow-circle-right"></i>
								</button>
								<button type="button" class="pull-right btn btn-default" id="sendEmail">Bloqueo
					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							<h3 class="card-title">
								...
								Interfaz para bloquear accesos por perfil
							</h3>
						...
						<div class="card-body">
							...
							<ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Datos</a>
								</li>
														...
														<div class="table-responsive demo-x content">
															<div class="box-body">
																...
																<div id="resultado_table">
																	...
																	<table id="table_ventas_bloeuqeo" class="table table-striped table-bordered text-rigth ">

																		<thead>
																			<tr>
																				<td style="width:10px">#</td>
																				<td style="width:70px">Perfil</td>
	...
	<script src="./js/inventario_blo.js"></script>
</body>
