    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Reserva</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">

                <button type="button" class="pull-right btn btn-default" id="sendEmail">Reserva
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Interfaz para registrar reservas.
              </h3>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12" style="display:none">
                                <div class="form-group">
                                  ...
                                  <select id="txt_bodega" class="form-control" name="txt_bodega" <?php if (!($_SESSION["gb_perfil"] == 1 || $_SESSION["gb_perfil"] == 7 || $_SESSION["gb_perfil"] == 8)) echo 'readonly="true"'; ?> >
                                  </select>
                  ...
                  <div class="card card-outline">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" placeholder="Seleccione Cliente..." class="form-control producto_auto limpiar ui-autocomplete-input" data-input_type="autocomplete" id="txt_cliente" name="txt_cliente" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off" onblur="validar_reserva();">	
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="txt_observaciones" name="txt_observaciones"  autocomplete="off" row="2"></textarea>
                          </div>
                        </div>
                        <br>
                        <br>
                  ...
                  <div class="card card-outline">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control producto_auto limpiar ui-autocomplete-input" data-input_type="autocomplete" id="txt_canal" name="txt_canal" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">	
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control producto_auto limpiar ui-autocomplete-input" data-input_type="autocomplete" id="txt_subcanal" name="txt_subcanal" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">	
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control producto_auto limpiar ui-autocomplete-input" data-input_type="autocomplete" id="txt_cupodisponible" name="txt_cupodisponible" maxlength="100" value="0" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">	
                          </div>
                        </div>
...
<button type="button" class="btn btn-info btn-block btn-flat" id="btn_crear_venta"><i class="fas fa-save"></i>Guardar Reserva</button>
...
<div class="row">
  ...
  <script src="./js/rv_registro.js"></script>
</body>
