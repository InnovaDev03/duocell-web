...
<div id="mensaje2"></div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Registro Cadenas/Tiendas</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">

                <button type="button" class="pull-right btn btn-default" id="sendEmail">Parametrizacion
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Interfaz para registrar/editar/eliminar Cadenas/Tiendas.
              </h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Registro Cadenas</h5>
                    </div>
                    <div class="card-body">
                      <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Ciudad</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_ciudad_cadena" autocomplete="off" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                          </div>
                        </div>

                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Dirección</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_direccion_cadena" autocomplete="off"  maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Fecha Registro</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_fecha_registro_cadena" value="<?php echo date("Y-m-d"); ?>" autocomplete="off" readonly="true"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="text-rihgt" id="create_cadena">
                              ...
                              <button type="button" id="btn_save_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Crear Cadena</button>
                            </div>
                            ...
                            <button type="button" id="btn_cancelar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Cancelar </button>
                              <button type="button" id="btn_editar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Editar Cadena</button>
                            </div>
                ...
                <div class="col-lg-8">
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Consulta Cadenas</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Registro Tiendas</h5>
                    </div>
                    <div class="card-body">
                      <div class="col-lg-12">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Nombre</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_nombre_tienda" autocomplete="off" maxlength="100" />
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Ciudad</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_ciudad_tienda" autocomplete="off" maxlength="100"/>
                          </div>
                        </div>

                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Promotor</strong><span style="color:#ff0000;">*</span></label>
                            <select class="form-control" id="txt_vendedor_cadena">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Dirección</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text" class="form-control" id="txt_direccion_tienda" autocomplete="off" maxlength="100"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="text-rihgt" id="create_tienda">
                              ...
                              <button type="button" id="btn_save_tienda" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Crear Tienda</button>
                            </div>
                ...
                <div class="col-lg-8">
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Consulta Tiendas</h5>
                    </div>
                    <div class="card-body">
                          ...
                          <div class="box-body">
                            ...
                            <table id="table_tiendas" class="table table-striped table-bordered text-center tabla_detalle_fp">
                              <thead>
                                <tr>
                                  <td style="width:10px">#</td>
                                  <td style="width:10px">Cadena</td>
                                  <td style="width:10px">Nombre</td>
                                  <td style="width:10px">Cuidad</td>
                                  <td style="width:10px">Dirección</td>
                                  <td style="width:80px">Promotor</td>
   <td style="width:10px">Fecha Registro</td>
                                  <td style="width:60px"></td>
                                </tr>
                              </thead>
                              <tbody>
  ...
  <script src="./js/gb_parametrizacion.js?v=<?php print_r(rand()) ?>"></script>
</body>
