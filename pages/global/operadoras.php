          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <button type="button" class="pull-right btn btn-default" id="sendEmail">Operadoras
                  <i class="fa fa-arrow-circle-right"></i>
              </ol>
            </div>
          </div>
...
<form  style="display: none" action="" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
            ...
            <hr>
                ...
                <div class="col-sm-12 col-md-12 col-lg-2">
                  <div class="form-group">
                      <a target="_blank" href="excel_operadoras.php" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-download"></i> Descargar datos</a>                    
                  </div>
                </div>
...
$query = "INSERT `precios_historial_operadoras` 
...
$query = "update `precios_operadoras` set estatus=0,
...
$query = "INSERT INTO `precios_operadoras`(`producto`, `subcanal`,  $concatsql
...
echo "<script>location.href='?opc=operadoras&cant=".$contador."'</script>";      
        }
...
<td>
  ...
  $sql         = "  SELECT Descripcion from CCSubCanal where CodCanal='004'  and estado='A' order by Descripcion desc";
...
<!--
 ...
 <?php
  ...
  //  $mysqli      = conexionMySQL();
    $data        = array();
    $sql         = "SELECT * FROM precios_operadoras WHERE producto = '".$nombreproducto. "' and estatus=1 ";
