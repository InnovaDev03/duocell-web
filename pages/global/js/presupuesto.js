...
$(document).on("click", "#btn_save_labor", function () {
		...
		if($('#txt_rubro').val().length != '' )
        	 {
             } else {
            NotifiError("Coloque nombre de la cadena");
            return true;
                }  
		if($('#txt_nivel1').val().length  != '' )
        	 { } else {
                NotifiError("Coloque la tienda");
            return true;
                } 
        ...
        var value = {
            ...
            txt_nivel1      : $("#txt_nivel1").val(),
            txt_nivel2  : $("#txt_nivel2").val(),
            txt_nivel3  : $("#txt_nivel3").val(),
            mes1       : $("#mes1").val(),
            mes2 : $("#mes2").val(),
            mes3       : $("#mes3").val(),
            mes4       : $("#mes4").val(),
                    ...
                    if (data.result == 1) {
                      ...
                      //  $("#txt_rubro").val('');
                       ...
                       table.ajax.reload( null, false );
                        ...
                        NotifiExito('Presupuesto Registrado!');                        
...
$(document).on("click", ".btn_delete_labor", function () {
		...
		Swal.fire({
			...
			text: "Tienda a eliminar: " + $(this).attr("nombre") + "",
			icon: 'warning',
				...
				$.ajax(
					{
                        ...
                        AlertaExito('EXITO', 'EXITO');
                        NotifiExito('Presupuesto eliminado!');                        
                        nivel1($("#txt_rubro").val());
...
$(document).on("click", ".btn_load_edit_labor", function () {
        ...
        document.getElementById("txt_nivel1").style.display = "none";
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (data.result == 1) {
                       ...
                       $("#mes6").val('');
                        ...
                        nivel1($("#txt_rubro").val());
                        AlertaExito('EXITO', 'EXITO');
                        NotifiExito('Presupuesto actualizado!');
                    }
                    else {
                        NotifiError(data.error);
                        AlertaExito('EXITO', 'EXITO');
