          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <button type="button" class="pull-right btn btn-default" id="sendEmail">Corporativo
                  <i class="fa fa-arrow-circle-right"></i>
              </ol>
            </div>
          </div>
...
<form  style="display: none" action="" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
            ...
            <hr>
                ...
                <div class="col-sm-12 col-md-12 col-lg-2">
                  <div class="form-group">
                      <a target="_blank" href="excel_corporativo.php" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-download"></i> Descargar datos</a>                    
                  </div>
                </div>
...
$query = "INSERT `precios_historial_corporativo` 
...
$query = "update `precios_corporativo` set estatus=0,
...
$query = "INSERT INTO `precios_corporativo`(`producto`, `subcanal`,  $concatsql
...
echo "<script>location.href='?opc=corporativo&cant=".$contador."'</script>";      
        }
...
*/
  ...
  $result = pg_query($dbconn," SELECT sc_descripcion from public.subcanal where ca_id=3 order by sc_descripcion desc");
...
<!--
 ...
 <?php
    ...
    $mysqli      = conexionMySQL();
    $data        = array();
    $sql         = "SELECT * FROM precios_corporativo WHERE producto = '".$nombreproducto. "' and estatus=1 ";
...
<?php echo $concat ?>
  ...
  <script src="./js/corporativo.js"></script>
