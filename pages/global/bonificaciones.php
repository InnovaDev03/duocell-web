    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" style="display: none">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Registro de Bonificaciones</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <button type="button" class="pull-right btn btn-default" id="sendEmail">Bonificaciones
                  <i class="fa fa-arrow-circle-right"></i>
              </ol>
            </div>
          </div>
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Interfaz para la gestión de Bonificaciones
              </h3>
            ...
            <div class="card-body">
              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                <li class="nav-item" style="display: none;">
                  <a class="nav-link" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="false"> Listado de Bonificaciones</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="true">Registro Bonificaciòn</a>
                </li>
...
<tr>
  <td>
  <input type="text"  placeholder="Seleccione Producto..."  class= "form-control producto_auto limpiar" data-input_type="autocomplete" class="form-control"  id="txt_producto" name="txt_producto" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();"/>	
...
<input type="text" class="form-control" id="mes12">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-12 col-md-6 col-lg-4"><br>
                                ...
                                <button type="button" id="btn_save_labor" class="btn btn-info btn-block btn-flat"><i class="fas fa-save"></i> Registrar Bonificación</button>
                                <button style="display: none;" type="button" id="btn_editar_labor" class="btn btn-info btn-block btn-flat"><i class="fas fa-save"></i> Editar Bonificación</button>
                                </div>
                              </div>
                            </div>
  ...
  <th>Item</th> 
    ...
    <th>Acción</th>
            ...
            <div class="card-footer">
              Registro/Consulta de Bonificaciones
            </div>
            <!-- /.card-footer-->
          </div>
...
Duocell
  ...
  <script src="./js/bonificaciones.js"></script>
</body>
