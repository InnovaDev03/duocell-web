    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Registro Mercaderista/Ventas</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">

                <button type="button" class="pull-right btn btn-default" id="sendEmail">Mercadiristas
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Interfaz para registrar ventas por Mercadirista.
              </h3>
              ...
              <div class="row">
                    ...
                    <div class="card-body">
                      <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="form-group">
                            <strong>Fecha De Venta</strong><span style="color:#ff0000;">*</span></label>
                ...
                <div class="col-lg-6">
                  <div class="card card-outline">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong>Cliente</strong><span style="color:#ff0000;">*</span></label>
                            <input type="text"  placeholder="Seleccione Cliente..."  class= "form-control producto_auto limpiar" data-input_type="autocomplete" class="form-control"  id="txt_cliente" name="txt_cliente" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();"/>	
                          </div>
                        </div>

                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <strong><br><br></strong><span style="color:#ff0000;"></span></label>
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="table-responsive demo-x content">
                          ...
                          <div class="text-left">
                              ...
                              <input type="text"  placeholder="Imei..."  class= "form-control producto_auto limpiar" data-input_type="autocomplete" class="form-control"  id="txt_producto" name="txt_producto" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();"/>	
														</div>
													</div>
                          ...
                          <div class="col-sm-12 col-md-12 col-lg-2">
                              ...
                              <input type="text"  placeholder="Cantidad..."  class= "form-control"  class="form-control"  id="txt_cantidad" name="txt_cantidad" value="1" maxlength="100" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" readonly="true"/>	
...
<button type="button" class="btn btn-info btn-block btn-flat" id="btn_crear_venta"><i class="fas fa-save"></i>Guardar Venta</button>
...
<div class="row">
  ...
  <script src="./js/mer_registro.js"></script>
</body>
