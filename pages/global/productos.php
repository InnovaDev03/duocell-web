...
<div id="mensaje2"></div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Habilitación de Productos</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">

                <button type="button" class="pull-right btn btn-default" id="sendEmail">Productos
                  <i class="fa fa-arrow-circle-right"></i>
                </button>
                <button type="button" class="pull-right btn btn-default" id="sendEmail">Habilitación
                  <i class="fa fa-arrow-circle-right"></i>
              </ol>
            </div>
          </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Habilitación de Productos</h5>
                    </div>
                    <div class="card-body">
                      <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="text-rihgt" id="create_cadena">
                              ...
                              <button type="button" id="btn_save_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-save"></i> Habilitar</button>
                            </div>
                            ...
                            <button type="button" id="btn_cancelar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Cancelar </button>
                              <button type="button" id="btn_editar_cadena" class="btn btn-outline-info btn-block btn-flat"><i class="fas fa-edit"></i> Deshabilitar</button>
                            </div>
                ...
                <div class="col-lg-8">
                  <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h5 class="m-0">Consulta de Productos</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="card-footer">
              Habilitación - Consulta Productos
                        </div>
            <!-- /.card-footer-->
          </div>
