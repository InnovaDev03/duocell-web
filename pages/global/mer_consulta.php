...
<body class="hold-transition sidebar-mini sidebar-collapse">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Consulta Ventas Mercaderista</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">

								<button type="button" class="pull-right btn btn-default" id="sendEmail">Mercaderista
					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							<h3 class="card-title">
								...
								Interfaz para consulta de ventas mercaderista.
							</h3>
											...
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-sm-2 col-md-12 col-lg-2">
														<div class="form-group">
															<h6>Cliente</h6>
															<input type="text" class="form-control" id="txt_cliente" name="txt_cliente" autofocus placeholder="Ingrese mayordomo">
														</div>
													</div>
	...
	<script src="./js/mer_consulta.js"></script>
</body>
